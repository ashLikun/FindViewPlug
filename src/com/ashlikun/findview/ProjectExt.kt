...
infix fun Project.isExtendsViewCompat(mClass: PsiClass): Boolean {
    // 根据类名查找类
    val viewClass = this findClassByProject "android.view.View"
    return viewClass != null && mClass checkInheritor viewClass
}
